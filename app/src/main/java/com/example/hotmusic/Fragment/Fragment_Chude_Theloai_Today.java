...
import com.example.hotmusic.Activity.DanhsachtatcachudeActivity;
import com.example.hotmusic.Activity.DanhsachtheloaitheochudeActivity;
...
public class Fragment_Chude_Theloai_Today extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        txtxemthemchudetheloai = view.findViewById(R.id.tvxemthem);
        ...
        callback.enqueue(new Callback<Theloaitrongngay>() {
            ...
            public void onResponse(Call<Theloaitrongngay> call, Response<Theloaitrongngay> response) {
                ...
                for (int i = 0; i < (chuDeArrayList.size()); i++){
                    ...
                    //4/4/2019 bắt sự kiện trả dữ liệu qua màn hình
                    final int finalI = i;
